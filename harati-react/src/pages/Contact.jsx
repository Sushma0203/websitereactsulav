        ...
        <main className="contact-page">
            ...
            <section className="product-section section fullwidth" style={{ backgroundColor: '#fff', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '60px', padding: '100px 40px' }}>
                <div style={{ flex: '1 1 400px', maxWidth: '500px', textAlign: 'left' }}>
                    <h2 style={{ fontSize: '36px', marginBottom: '30px' }}>Shop Details</h2>
                    ...
                    <p style={{ marginBottom: '20px', fontSize: '18px' }}><i className="fas fa-envelope" style={{ color: 'var(--premium-gold)', marginRight: '15px' }}></i> haratimaa@gmail.com</p>
                    <p style={{ marginBottom: '20px', fontSize: '18px' }}><i className="fas fa-clock" style={{ color: 'var(--premium-gold)', marginRight: '15px' }}></i> Opening Hours: 10 AM - 7 PM</p>
                </div>
                ...
                <div style={{ flex: '1 1 400px', maxWidth: '540px', background: '#fff', padding: '50px', borderRadius: '30px', boxShadow: 'var(--shadow-premium)', border: '1px solid rgba(197, 160, 89, 0.2)' }}>
                    ...
                    <form>
                        ...
                        <textarea placeholder="How can we help you?" rows="5" style={{ width: '100%', padding: '15px', marginBottom: '30px', border: '1px solid #eee', borderRadius: '12px', background: '#f9f9f9', fontFamily: 'inherit' }}></textarea>
